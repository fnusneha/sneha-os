...
coverage map, and upcoming-trip pins, then fills `templates/rides.html`
and writes the result to `~/rides_report.html`.
...
# (Year-over-year comparison was removed — it cluttered /rides
#  without adding insight. High-level annual progress now lives
#  on the Year tab via the yearly widget + CA coverage map.)
