...
# Weekly = 6 × daily — one rest day baked in. Bumped alongside the
# daily goal so the weekly bar stays on the same "6 active days" curve
# instead of getting easier by accident when daily got harder.
